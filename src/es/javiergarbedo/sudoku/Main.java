...
public class Main extends javax.swing.JFrame {
    ...
    public Main() throws IOException {
        ...
        locale.getDefault();
        ResourceBundle bundle1 = ResourceBundle.getBundle("locales/locales.properties", locale);
        jLabelLevel.setText(String.valueOf(bundle1.getString("Nivel Completado :")));
        ...
        properties.load(new FileReader("saveLevel.properties"));
        properties.store(new BufferedWriter(new FileWriter("saveLevel.properties")), lastLevel);

        jComboBox1.setSelectedIndex(Integer.valueOf(lastLevel));
        int levelSelected = jComboBox1.getSelectedIndex();
        setLevel(levelSelected);

        ResourceBundle bundle = ResourceBundle.getBundle("locales/locales.properties", locale);
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        ...
        String numLevel = String.valueOf(jComboBox1.getSelectedIndex());
        try {
            properties.store(new BufferedWriter(new FileWriter("saveLevel.properties")), numLevel);
        } catch (IOException ex) {
            Logger.getLogger(Main.class.getName()).log(Level.SEVERE, null, ex);
        }
